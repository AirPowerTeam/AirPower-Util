...
export class RandomUtil {
   ...
   * ### 数字集合
   */
  private static STRING_OF_NUMBER = '0123456789'

  /**
   * ### 小写字母集合
   */
  private static STRING_OF_LOWER_CHAR = 'abcdefghijklmnopqrstuvwxyz'

  /**
   * ### 大写字母集合
   */
  private static STRING_OF_UPPER_CHAR = this.STRING_OF_LOWER_CHAR.toUpperCase()
